...
import { IPAddress, IPAssignmentPayload, IPRange, IPSharingPayload } from './types';
/**
 * Returns a paginated list of IP Addresses on your Account, excluding private
 * addresses.
 *
 */
export declare const getIPs: (params?: any, filters?: any) => Promise<Page<IPAddress>>;
/**
 ...
 *
 */
export declare const getIPv6Pools: (params?: unknown) => Promise<Page<IPRange>>;
/**
 * Displays the IPv6 ranges on your Account.
 *
 */
export declare const getIPv6Ranges: (params?: any) => Promise<Page<IPRange>>;
