 ...
 */
export declare const createNodePool: (clusterID: number, data: PoolNodeRequest) => Promise<KubeNodePoolResponse>;
/**
 * updateNodePool
 *
 * Change the type or count of a node pool
 */
export declare const updateNodePool: (clusterID: number, nodePoolID: number, data: PoolNodeRequest) => Promise<KubeNodePoolResponse>;
/**
 * deleteNodePool
 *
