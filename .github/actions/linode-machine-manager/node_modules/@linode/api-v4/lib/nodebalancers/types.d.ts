...
export declare type NodeBalancerConfigNodeMode = 'accept' | 'reject' | 'backup' | 'drain';
...
export declare type NodeBalancerProxyProtocol = 'none' | 'v1' | 'v2';
...
export declare type UpdateNodeBalancerConfig = CreateNodeBalancerConfig;
...
export declare type UpdateNodeBalancerConfigNode = Partial<CreateNodeBalancerConfigNode>;
