 ...
 */
export declare const cloneDomain: (domainId: number, cloneName: string) => Promise<Domain>;
/**
 ...
 */
export declare const importZone: (domain: string, remote_nameserver: string) => Promise<Domain>;
