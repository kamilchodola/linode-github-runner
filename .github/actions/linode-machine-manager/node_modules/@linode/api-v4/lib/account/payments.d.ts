...
import { ClientToken, ExecutePayload, Payment, PaymentMethod, PaymentResponse, Paypal, PaypalResponse, SaveCreditCardData, PaymentMethodData, MakePaymentData } from './types';
/**
 * getPayments
 *
 ...
 *
 */
export declare const addPaymentMethod: (data: PaymentMethodData) => Promise<{}>;
/**
