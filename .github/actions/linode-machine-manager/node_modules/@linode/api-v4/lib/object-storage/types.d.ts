...
export declare type AccessType = 'read_only' | 'read_write' | 'none';
...
export declare type ACLType = 'private' | 'public-read' | 'authenticated-read' | 'public-read-write' | 'custom';
...
export declare type ObjectStorageClusterID = 'us-east-1' | 'eu-central-1' | 'ap-south-1' | 'us-southeast-1';
