 ...
 */
export declare const getObjectList: (clusterId: string, bucketName: string, params?: ObjectStorageObjectListParams | undefined) => Promise<ObjectStorageObjectListResponse>;
/**
 * uploadSSLCert
 */
