 ...
 */
export declare const updateCredential: (credentialID: number, data: UpdateCredentialPayload) => Promise<Page<ManagedCredential>>;
/**
 * updatePassword
 *
 * Update the username and/or password on a Managed Credential on your account.
 */
export declare const updatePassword: (credentialID: number, data: UpdatePasswordPayload) => Promise<Page<ManagedCredential>>;
/**
 * deleteCredential
 *
