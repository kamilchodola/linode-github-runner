export declare type FirewallStatus = 'enabled' | 'disabled' | 'deleted';
export declare type FirewallRuleProtocol = 'ALL' | 'TCP' | 'UDP' | 'ICMP';
export declare type FirewallDeviceEntityType = 'linode' | 'nodebalancer';
export declare type FirewallPolicyType = 'ACCEPT' | 'DROP';
