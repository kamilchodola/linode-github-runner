 ...
 */
export declare const createImage: (diskId: number, label?: string | undefined, description?: string | undefined) => Promise<Image>;
/**
 ...
 * @param description { string } A detailed description of this Image.
 */
export declare const updateImage: (imageId: string, label?: string | undefined, description?: string | undefined) => Promise<Image>;
/**
