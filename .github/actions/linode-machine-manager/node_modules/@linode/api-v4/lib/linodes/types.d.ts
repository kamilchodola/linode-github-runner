...
export declare type Hypervisor = 'kvm' | 'zen';
...
export declare type Window = 'Scheduling' | 'W0' | 'W2' | 'W4' | 'W8' | 'W10' | 'W12' | 'W14' | 'W16' | 'W18' | 'W20' | 'W22';
export declare type Day = 'Scheduling' | 'Sunday' | 'Monday' | 'Tuesday' | 'Wednesday' | 'Thursday' | 'Friday' | 'Saturday';
...
export declare type Filesystem = 'raw' | 'swap' | 'ext4' | 'ext3' | 'initrd';
...
export declare type LinodeBackupType = 'auto' | 'snapshot';
export declare type LinodeBackupStatus = 'pending' | 'running' | 'paused' | 'needsPostProcessing' | 'successful' | 'failed' | 'userAborted';
...
export declare type LinodeStatus = 'offline' | 'booting' | 'running' | 'shutting_down' | 'rebooting' | 'rebuilding' | 'provisioning' | 'deleting' | 'migrating' | 'cloning' | 'restoring' | 'stopped';
export declare type InterfacePurpose = 'public' | 'vlan';
...
export declare type KernelArchitecture = 'x86_64' | 'i386';
...
export declare type DiskStatus = 'offline' | 'booting' | 'running' | 'shutting_down' | 'rebooting' | 'provisioning' | 'deleting' | 'migrating' | 'ready';
...
export declare type LinodeTypeClass = 'nanode' | 'standard' | 'dedicated' | 'highmem' | 'gpu' | 'metal';
...
export declare type RescueRequestObject = Pick<Devices, 'sda' | 'sdb' | 'sdc' | 'sdd' | 'sde' | 'sdf' | 'sdg'>;
